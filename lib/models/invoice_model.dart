...
//   // Factory method to create ProductItem from map (for database operations)
//   factory ProductItem.fromMap(Map<String, dynamic> map) {
//     return ProductItem(
//       invoiceNumber: map['invoiceNumber'] ?? '',
//       productName: map['productName'] ?? '',
//       description: map['description'] ?? '', // ✅ Fetching from map
...
//       address: map['address'] ?? '',
//       hsn: map['hsn'] ?? '',
//       // taguru: map['taguru']?.toDouble() ?? 0.0,
...
//   // Convert ProductItem to map (for database operations)
