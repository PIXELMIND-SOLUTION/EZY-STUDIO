  ...
  Widget _buildHelpSheet() {
    return Padding(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text('• Use high-contrast photos for best results.'),
        Text('• If the result looks rough, try a different photo size or crop.'),
        const SizedBox(height: 12),
        Text('Controls', style: TextStyle(fontWeight: FontWeight.bold)),
        const SizedBox(height: 8),
        Text('• Drag the divider to compare before/after.'),
      ...
      Row(children: [
        ...
        Expanded(
          child: ElevatedButton.icon(
            ...
            style: ElevatedButton.styleFrom(backgroundColor: Colors.purple.shade700, padding: const EdgeInsets.symmetric(vertical: 14), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))),
          ),
        ),
      ]),
