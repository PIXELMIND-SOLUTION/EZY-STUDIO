...
import 'package:edit_ezy_project/models/story_model.dart';
...
import 'package:edit_ezy_project/views/story/add_story_screen.dart';
...
class _StoryViewerScreenState extends State<StoryViewerScreen>
  ...
  String? _getUserProfileImage() {
    if (_isCurrentUserOwner) {
      return Provider.of<StoryProvider>(context, listen: false).currentUserImage;
    } else {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'This story will be reviewed by our moderation team. The user won\'t be notified about this report.',
                            style: TextStyle(
                              fontSize: 16,
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color: _shouldBlock ? Colors.blue[300]! : Colors.grey[300]!,
                                width: 2,
                              ),
                            ),
                            child: InkWell(
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    ...
                                    height: 24,
                                    decoration: BoxDecoration(
                                      color: _shouldBlock ? Colors.blue[600] : Colors.transparent,
                                      border: Border.all(
                                        color: _shouldBlock ? Colors.blue[600]! : Colors.grey[400]!,
                                        width: 2,
                                      ),
                              ...
                              Expanded(
                                child: ElevatedButton(
                                  onPressed: reportProvider.isLoading 
                                      ? null 
                                      : () async {
                                          await _handleReportSubmission(reportProvider);
                                        },
  ...
  Future<void> _handleReportSubmission(ReportStoryProvider reportProvider) async {
    try {
            ...
            SnackBar(
              content: Row(
                children: [
                  ...
                  const SizedBox(width: 12),
                  Text(reportProvider.successMessage ?? 'Report submitted successfully'),
                ],
              ),
  ...
  Future<void> _showDeleteConfirmation() async {
    ...
    if (confirmed == true) {
      ...
      final success = await storyProvider.deleteStory(storyId, userId, mediaUrl);
                        ...
                        Container(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              image: _getUserProfileImage() != null && _getUserProfileImage()!.isNotEmpty
                                  ? DecorationImage(
                                      image: NetworkImage(_getUserProfileImage()!),
                                      fit: BoxFit.cover,
                            ...
                            child: _getUserProfileImage() == null || _getUserProfileImage()!.isEmpty
                                ? const Icon(
